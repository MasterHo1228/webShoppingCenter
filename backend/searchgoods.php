...
if (!empty($_GET['gKey'])){
    ...
    $queryFind=mysqli_query($link,"SELECT gID,gName,gPrice,gOriginPrice,gRankTop,gSoldOutNum,sUName,gPhoto FROM viewshowgoodsdetail WHERE gName LIKE '%$gKey%' ORDER BY gSoldOutNum DESC ;");
